...
const OAUTH2_CONFIG = {
    ...
    clientID: process.env.OAUTH2_CLIENT_ID || 'orders-service-client',
    clientSecret: process.env.OAUTH2_CLIENT_SECRET || 'orders-service-secret',
...
passport.use(new JwtStrategy(JWT_OPTIONS, (payload, done) => {
    try {
        // In a real application, you would validate the JWT payload
        const user = {
